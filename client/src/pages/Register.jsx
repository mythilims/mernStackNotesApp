        ...
        <div className="relative z-10 min-h-screen flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 w-full flex flex-col justify-center items-center p-8 lg:p-12">
            <div className="text-center space-y-6 max-w-md">
              ...
              <div className="pt-4">
                <Link to={'/login'}>
                  <button className="group relative overflow-hidden bg-white/10 bg-[#2A4759] backdrop-blur-sm border border-white/20 text-white rounded-2xl px-8 py-4 text-lg font-semibold hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-10">
                <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <label className="placeholder-white block text-sm font-medium text-gray-200 mb-2">
                        Email Address
                      </label>
                      <input
                        type="email"
